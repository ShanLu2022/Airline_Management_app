...
2. Administrative system for staff
  ...
  '''
  Select @n:=(@n := @n +1) AS Seq_Num, t.FlightID, t.FlightNum, t.FlightDate, t.Aircraft, t.DepTime, t.FlightStatus, 
			t.Seating, t.PassengerID, t.FirstName, t.LastName, t.EmailAddress
   From 
    (Select fl.FlightID, fl.FlightNum, fl.FlightDate, fl.Aircraft, fl.DepTime,
      ...
      Where fl.FlightID = %s Order by ps.LastName asc, ps.FirstName asc) t Cross join (SELECT @n:= 0) AS parameter
  '''
